...
class Cholec80(SurgicalDataset):
    """
    PSI-AVA dataloader.
    """

    def __init__(self, cfg, split):
        self.dataset_name = "cholec80"
        self.zero_fill = 6
        self.image_type = "jpg"
        self.cfg = cfg
    ...
    def __getitem__(self, idx):
        ...
        complete_name = '{}/{}_{}.{}'.format(video_name, video_name, str(sec).zfill(self.zero_fill), self.image_type)
...
@DATASET_REGISTRY.register()
class Cholec80ms(SurgicalDataset):
    """
    PSI-AVA dataloader.
    """

    def __init__(self, cfg, split):
        self.dataset_name = "cholec80ms"
        self.zero_fill = 6
        self.image_type = "jpg"
        self.cfg = cfg
...
@DATASET_REGISTRY.register()
class Cholec80chunks(SurgicalDatasetChunks):
    """
    PSI-AVA dataloader.
    """
    ...
    def __init__(self, cfg, split):
        super().__init__(cfg,split)
        self.dataset_name = "Cholec80chunks"
        self.cfg = cfg
        self.zero_fill = 6
        self.image_type = "jpg"
    ...
    def __getitem__(self, idx):
        ...
        image_paths = ['{}/{}_{}.{}'.format(video_name, video_name, str(sec).zfill(self.zero_fill), self.image_type) for sec in chunk]

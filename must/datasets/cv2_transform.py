...
def random_short_side_scale_jitter_list(images, min_size, max_size):
    """
...
def horizontal_flip_list(prob, images, order="CHW"):
    """
...
def spatial_shift_crop_list(size, images, spatial_shift_pos):
    """

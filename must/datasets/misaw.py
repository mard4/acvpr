...
class Misaw(SurgicalDataset):
    """
    PSI-AVA dataloader.
    """

    def __init__(self, cfg, split):
        self.dataset_name = "misaw"
        self.zero_fill = 5
        self.image_type = "jpg"
        self.cfg = cfg
    ...
    def __getitem__(self, idx):
        """
        Generate corresponding clips, labels and metadata for given idx.
        ...
        Returns:
            ...
            idx (int): the video index provided by the pytorch sampler.
            extra_data (dict): a dict containing extra data fields
        """
...
@DATASET_REGISTRY.register()
class Misawchunks(SurgicalDatasetChunks):
    """
    PSI-AVA dataloader.
    """
